...
def local_explanations(state, orig, form="as_list"):
    ...
    explainer = lime_tabular.LimeTabularExplainer(
        ...
        mode="classification" if state.task_type=="분류" else "regression",
    ...
    if state.task_type == "분류":
        ...
        def predict_fn(data):
            transformed = forward_transform(state, data, look_nums=True)
